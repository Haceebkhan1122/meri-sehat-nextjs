...
function WhatsappButton() {
    ...
    useEffect(() => {
        if (router.pathname !== "/page/sehat-a-z/" && router.pathname !== "/page/sehat-a-z" && router.pathname !== "/page/sehat-scan/" && router.pathname !== "/page/sehat-scan") {
    ...
    return (
        <>
            {shouldRender && (
                <div className={(router.pathname === "/subscription" || router.pathname === "/wallet" ||  router.pathname === "/pricing" || router.pathname === "/"  ) ? "btn_hide_mob" :'whatsapp-btn'} onClick={whatsappHandler}>
                    <div id="wa-btn-content">
                        ...
                        <p style={{ color: 'white', marginLeft: 'inherit' }}>WhatsApp Us</p>
                    </div>
                </div>
            )}
        </>
